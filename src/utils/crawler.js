...
export async function scrapeJobs(jobTitle,experience,cityTypeGid) {
  ...
  if(cityTypeGid == undefined){
    naukriURL = `https://www.naukri.com/${encodeURIComponent(jobTitle)}-jobs?experience=${experience}`
  }
  if(cityTypeGid ){
...
// Set the random user agent before navigating to the page
